...
import (
	...
	"github.com/bluebosh/knap/pkg/controller"
...
func main() {
	...
	err = leader.Become(ctx, "knap-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	// Setup Scheme for tekton
	if err := pipev1.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}

	// Setup Scheme for knative
